...
def main():
	...
	if dog == '':
		...
		slowprint('\x1b[00mSuccess, file auto saved as \x1b[33mTERSIMPAN DI FOLDER INI KALO KALIAN MAU PINDAH KAN KE SDCARD TINGGAL KETIK cp Hasil-Ariel.py /sdcard')
		os.system('xdg-open https://youtube.com/Ariel69Channel')
	elif dog == '2':
		os.system('nano Hasil-Ariel.py')
		main()
	elif dog == '3':
